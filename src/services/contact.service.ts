...
class ContactService {
  async create(contact: ContactDTO) {
    try {
      ...
      logMessage(LogLevel.INFO, 'Contact created successfuly.' + { ...contactCreated },);

      return { ...contactCreated };

    } catch (error) {

      logMessage(LogLevel.ERROR, 'Cannot create an contact', { message: error.message });
  ...
  async edit(updateData: Partial<ContactDTO>, id: number) {
    try {
      ...
      logMessage(LogLevel.ERROR, 'Cannot edit an contact', { message: error.message });
  ...
  async delete(id: number) {
    try {
      ...
      logMessage(LogLevel.ERROR, 'Cannot delete an contact.', { message: error.message });
  ...
  async getAll() {
    try {
      ...
      logMessage(LogLevel.ERROR, 'Cannot get contact list.', { message: error.message });
  ...
  async getContact(id: number) {
    try {
      ...
      logMessage(LogLevel.ERROR, 'Cannot get contact.', { message: error.message });
